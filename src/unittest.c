...
TEST_GROUP(apint,
           {
               ...
               TEST_CASE(multiply mantissa of pi with itself karatsuba extended,
                         {
                             apint_setlimb(apint_test[0], 3, 0x6487ED5110B4611A);
                             apint_setlimb(apint_test[0], 2, 0x62633145C06E0E68);
                             apint_setlimb(apint_test[0], 1, 0x948127044533E63A);
               ...
               TEST_CASE(multiply mantissa of pi with itself karatsuba OPT1,
                         {
                             apint_setlimb(apint_test[0], 3, 0x6487ED5110B4611A);
                             apint_setlimb(apint_test[0], 2, 0x62633145C06E0E68);
                             apint_setlimb(apint_test[0], 1, 0x948127044533E63A);
               ...
               TEST_CASE(multiply mantissa of pi with itself karatsuba OPT2,
                         {
                             apint_setlimb(apint_test[0], 3, 0x6487ED5110B4611A);
                             apint_setlimb(apint_test[0], 2, 0x62633145C06E0E68);
                             apint_setlimb(apint_test[0], 1, 0x948127044533E63A);
                             ...
                             apint_mul_karatsuba_OPT2(apint_test[2], apint_test[0], apint_test[1]);
               ...
               TEST_CASE(multiply propagate karatsuba extended,
                         {
                             apint_setlimb(apint_test[0], 3, 0xffffffffffffffff);
                             apint_setlimb(apint_test[0], 2, 0xffffffffffffffff);
                             apint_setlimb(apint_test[0], 1, 0xffffffffffffffff);
               ...
               TEST_CASE(multiply propagate karatsuba OPT1,
                         {
                             apint_setlimb(apint_test[0], 3, 0xffffffffffffffff);
                             apint_setlimb(apint_test[0], 2, 0xffffffffffffffff);
                             apint_setlimb(apint_test[0], 1, 0xffffffffffffffff);
               ...
               TEST_CASE(multiply propagate karatsuba OPT2,
                         {
                             apint_setlimb(apint_test[0], 3, 0xffffffffffffffff);
                             apint_setlimb(apint_test[0], 2, 0xffffffffffffffff);
                             apint_setlimb(apint_test[0], 1, 0xffffffffffffffff);
...
TEST_GROUP(apbar2,
           {
               ...
               TEST_CASE(apbar2
                         : apbar2_add addition with positive numbers 1.000...00 X 2 ^ 10 + 1.000...00 X 2 ^ 10,
                           {
               ...
               TEST_CASE(apbar2
                         : apbar2_add addition with positive numbers 1.111...11 X 2 ^ 10 + 1.111...11 X 2 ^ 10,
                           {
               ...
               TEST_CASE(apbar2
                         : apbar2_add addition with positive numbers 1.000...01 X 2 ^ 256 + 1.000...00 X 2 ^ 1,
                           {
                               apbar2_set_midpt_limb(apbar2_test[0], 3, 0x8000000000000000LLU);
                               apbar2_set_midpt_limb(apbar2_test[0], 2, 0);
                               apbar2_set_midpt_limb(apbar2_test[0], 1, 0);
               ...
               TEST_CASE(apbar2
                         : apbar2_add with positive and negative number 1.000...00 X 2 ^ 256 + -1.000...00 X 2 ^ 192,
                           {
               ...
               TEST_CASE(apbar2
                         : subtraction with positive numbers a - b a > b,
                           {
                               apbar2_set_d(apbar2_test[0], 1.0);
                               apbar2_set_midpt_exp(apbar2_test[0], 256);
                               apbar2_set_sign(apbar2_test[0], 0);
               ...
               TEST_CASE(apbar2
                         : subtraction with positive numbers a - b a > b 2pi - pi,
                           {
               ...
               TEST_CASE(apbar2
                         : subtraction with positive - negative number a - b a > b,
                           {
                               apbar2_set_midpt_limb(apbar2_test[0], 3, 0x8000000000000000LLU);
                               apbar2_set_midpt_limb(apbar2_test[0], 2, 0);
                               apbar2_set_midpt_limb(apbar2_test[0], 1, 0);
               ...
               TEST_CASE(apbar2
                         : subtraction with negative - positive number a - b a > b,
                           {
                               apbar2_set_midpt_limb(apbar2_test[0], 3, 0x8000000000000000LLU);
                               apbar2_set_midpt_limb(apbar2_test[0], 2, 0);
                               apbar2_set_midpt_limb(apbar2_test[0], 1, 0);
               ...
               TEST_CASE(apbar2
                         : subtract with differing signs and overflow,
                           {
                               apbar2_set_midpt_limb(apbar2_test[0], 3, 0xffffffffffffffffLLU);
