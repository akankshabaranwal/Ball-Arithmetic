...
static void int_mul_unroll4(uint prec)
{
    for (size_t i = 0; i < BENCHMARK_ITER; ++i)
    {
...
static void int_mul_unroll12(uint prec)
{
    for (size_t i = 0; i < BENCHMARK_ITER; ++i)
    {
        apint_mul_unroll12(out, in1, in2);
    }
}

static void int_mul_unroll8(uint prec)
{
...
static void int_mul_karatsuba_opt2(uint prec)
{
    for (size_t i = 0; i < BENCHMARK_ITER; ++i)
    {
        apint_mul_karatsuba_OPT2(out, in1, in2);
    }
}
...
BENCHMARK_BEGIN_TABLE(ball_mul_all)
    ...
    BENCHMARK_FUNCTION(barith_mul_intrinsic, ball_init, ball_cleanup, 4.0, 8, 18)
...
BENCHMARK_BEGIN_TABLE(karatsuba)
    ...
    BENCHMARK_FUNCTION(int_mul_karatsuba_opt2, int_init, int_cleanup, 1.0, 8, 18)
BENCHMARK_END_TABLE(karatsuba)

BENCHMARK_BEGIN_TABLE(unroll)
    BENCHMARK_FUNCTION(int_mul, int_init, int_cleanup, 1.0, 8, 17)
    BENCHMARK_FUNCTION(int_mul_unroll8, int_init, int_cleanup, 1.0, 8, 17)
    BENCHMARK_FUNCTION(int_mul_unroll4, int_init, int_cleanup, 1.0, 8, 17)
    BENCHMARK_FUNCTION(int_mul_unroll12, int_init, int_cleanup, 1.0, 8, 17)
BENCHMARK_END_TABLE(unroll)
