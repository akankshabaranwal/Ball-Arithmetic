...
void apint_mult_test1()
{
    ...
    apint_init(x, 512); // the number of bits for x needs to be the sum of bits for a and b
    apint_init(a, 512); // 16 limbs!
    apint_init(b, 512);
    ...
    apint_setlimb(a, 0, 1); // 0x8 0x0 * 0x0 0x2 = 0x10 0x0
    apint_setlimb(a, 1, 1);
    apint_setlimb(a, 2, 1);
    apint_setlimb(a, 3, 1);
    apint_setlimb(a, 4, 0);
    ...
    apint_setlimb(a, 6, 0);
    apint_setlimb(a, 7, 0);
    // apint_setlimb(a, 8, 0); // 0x8 0x0 * 0x0 0x2 = 0x10 0x0
    // apint_setlimb(a, 9, 0);
    // apint_setlimb(a, 10, 0);
    // apint_setlimb(a, 11, 0);
    // apint_setlimb(a, 12, 0);
    // apint_setlimb(a, 13, 0);
    // apint_setlimb(a, 14, 0);
    // apint_setlimb(a, 15, 0);

    // if we have 0x1 0x0, what does this number actually represent???
    apint_setlimb(b, 0, 3); // 0x8 0x0 * 0x0 0x2 = 0x10 0x0
    apint_setlimb(b, 1, 3);
    apint_setlimb(b, 2, 3);
    apint_setlimb(b, 3, 3);
    apint_setlimb(b, 4, 0);
    ...
    // apint_setlimb(b, 8, 0);
    // apint_setlimb(b, 9, 0);
    // apint_setlimb(b, 10, 0);
    // apint_setlimb(b, 11, 0);
    // apint_setlimb(b, 12, 0);
    // apint_setlimb(b, 13, 0);
    // apint_setlimb(b, 14, 0);
    // apint_setlimb(b, 15, 0);
    ...
    // apint_mul_karatsuba_extend_basecase(x, a, b);
    // apint_mul_karatsuba_OPT1(x, a, b);
    apint_mul_karatsuba_OPT2(x, a, b);
    // apint_mul(x, a, b);
